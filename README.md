...
| 5.2.0 (upcoming minor release) [SNAPSHOT](https://oss.sonatype.org/content/repositories/snapshots/org/openapitools/openapi-generator-cli/5.2.0-PITS-4/) | Jun/Jul 2021   | Minor release with breaking changes (with fallback) |
